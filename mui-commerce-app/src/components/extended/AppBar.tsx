        ...
        <Container maxWidth="xl">
          <Toolbar>
            ...
            >
              ...
              <Button color="inherit" component={Link} href="/commerce">
                ...
                {drawerToggle && (
                  ...
                  >
                    <List>
                      ...
                      <Link style={{ textDecoration: 'none' }} href="/commerce">
                        <ListItemButton component="a">
                          <ListItemIcon>
                            <IconBuildingStore />
                          </ListItemIcon>
                          <ListItemText
                            primary={<FormattedMessage id="commerce" />}
                          />
                        </ListItemButton>
                      </Link>
